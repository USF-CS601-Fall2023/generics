...
public class WildCardsExample {
    ...
    /*
    // Does not compile; We cannot pass the parent where the child is expected
    public static void insertCircle1Wrong(List<? extends Circle> list, float rad) {
    ...
    public static void main(String[] args) {
        ...
        List<Circle> list1 = new ArrayList<>();
